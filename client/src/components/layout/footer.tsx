      ...
      <div className="container mx-auto px-6 md:px-12">
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="mb-6">
              <h3 className="font-serif text-2xl font-bold tracking-tight text-white mb-1">Cornerstone</h3>
              <p className="text-xs uppercase tracking-[0.2em] text-gray-400">Law Group, P.C.</p>
            </div>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="font-serif text-lg font-medium mb-6 text-accent">Navigation</h4>
            <ul className="space-y-3">
              {NAV_LINKS.map(link => (
                <li key={link.href}>
                  <Link href={link.href}>
                    <a className="text-gray-300 hover:text-white transition-colors text-sm">{link.label}</a>
                  </Link>
                </li>
              ))}
              <li>
          ...
          {/* Hours */}
          <div>
            <h4 className="font-serif text-lg font-medium mb-6 text-accent">Hours</h4>
        ...
        <div className="mt-8 p-4 bg-white/5 rounded text-[10px] text-gray-500 leading-relaxed text-center md:text-left">
