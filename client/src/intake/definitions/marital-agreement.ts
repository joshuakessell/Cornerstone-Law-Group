...
export const maritalAgreementIntake: IntakeDef = {
  intakeType: "marital-agreement",
  title: "Client Intake: Marital Agreement",
  description: "Information to prepare your marital agreement.",
  steps: [
    {
      id: "your-info",
    ...
    },
    {
      ...
      fields: [
        ...
        { id: "spouseEmployerName", label: "Employer name", type: "text" },
        { id: "spouseEmployerAddress", label: "Employer address", type: "text" },
        { id: "spouseOccupation", label: "Occupation", type: "text" },
        { id: "spouseWorkPhone", label: "Work phone", type: "tel" },
      ],
    },
    {
      id: "marriage-info",
