    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          <img 
            src={heroImage} 
            alt="Cornerstone Law Group Office" 
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10 pt-20">
          <div className="max-w-3xl">
            <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl font-bold leading-[1.1] mb-6 text-primary">
              Family... <br/>
              <span className="text-accent italic">The Cornerstone</span> of Life.
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild size="lg" className="rounded-full text-lg px-8 h-14 bg-primary hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all">
                <Link href="/contact">Schedule a Consultation</Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="rounded-full text-lg px-8 h-14 border-2 border-primary text-primary hover:bg-primary/5">
      ...
      {/* Trust Section */}
      <Section background="muted" padded className="border-y border-gray-100">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            <Shield className="w-10 h-10 text-accent mb-6" />
            <h3 className="text-xl font-serif font-bold mb-3 text-primary">Protecting Assets</h3>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-serif font-bold mb-3 text-primary">Child-Centered</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-serif font-bold mb-3 text-primary">Strategic Advocacy</h3>
            <p className="text-gray-600 leading-relaxed">
      ...
      <Section padded>
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="order-1 lg:order-2">
            <span className="text-accent font-bold uppercase tracking-widest text-sm mb-2 block">Our Approach</span>
            <h2 className="font-serif text-4xl md:text-5xl font-bold mb-6 text-primary">We Do Things Differently</h2>
            ...
            <Button asChild variant="link" className="text-primary font-bold text-lg p-0 hover:text-accent transition-colors">
      ...
      <Section background="muted" padded>
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-accent font-bold uppercase tracking-widest text-sm mb-2 block">Practice Areas</span>
          <h2 className="font-serif text-4xl font-bold mb-4 text-primary">Comprehensive Family Law Services</h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {SERVICES.slice(0, 6).map((service) => (
            <Link key={service.slug} href="/services">
              <a className="group bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 block h-full">
                <h3 className="font-serif text-2xl font-bold mb-3 text-primary group-hover:text-accent transition-colors">
                  {service.title}
                </h3>
      ...
      <Section padded>
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-accent font-bold uppercase tracking-widest text-sm mb-2 block">Why Choose Us</span>
            <h2 className="font-serif text-4xl md:text-5xl font-bold mb-6 text-primary">A Future You Can Look Forward To</h2>
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
            ...
            <div className="space-y-6">
              {TESTIMONIALS.map((testimonial, idx) => (
                <blockquote key={idx} className="border-l-4 border-accent pl-4 italic text-gray-600 bg-gray-50 p-4 rounded-r-lg">
                  "{testimonial.quote}"
