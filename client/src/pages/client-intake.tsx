                      ...
                      >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-center justify-between">
                            <p className="font-medium truncate">{formLabel(form.formType)}</p>
                            <Button
                              variant="ghost"
                              size="icon"
                              className="h-8 w-8"
                            ...
                            >
                              <a href={form.files.pdf} download aria-label={`Download ${formLabel(form.formType)}`}>
                                <Download className="h-4 w-4" />
                              </a>
                            </Button>
                          </div>
                          <p className="text-xs text-muted-foreground mt-1">
                            {new Date(form.completedAt).toLocaleString()}
                          </p>
                        </div>
