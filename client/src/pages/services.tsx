      ...
      <Section padded>
        <div className="max-w-4xl mx-auto space-y-24">
          {SERVICES.map((service, index) => (
            <div key={service.slug} id={service.slug} className="scroll-mt-32 border-b border-gray-100 pb-16 last:border-0">
              ...
              <Accordion type="single" collapsible className="w-full">
                <AccordionItem value="details" className="border-0">
                  ...
                  <AccordionContent className="text-gray-600 leading-relaxed text-base pt-4">
                    <p className="mb-4">
